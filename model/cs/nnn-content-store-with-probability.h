 ...
 *
 *  nnn-content-store-with-probability.h is free software: you can redistribute it and/or modify
 *  it under the terms of the GNU Affero General Public License as published by
 *  the Free Software Foundation, either version 3 of the License, or
 *  (at your option) any later version.
 *
 *  nnn-content-store-with-probability.h is distributed in the hope that it will be useful,
 *  but WITHOUT ANY WARRANTY; without even the implied warranty of
 *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 *  GNU Affero General Public License for more details.
 *
 *  You should have received a copy of the GNU Affero General Public License
 *  along with nnn-content-store-with-probability.h. If not, see <http://www.gnu.org/licenses/>.
 *
...
#include "ns3/nnn-content-store-impl.h"

#include "ns3/nnn-multi-policy.h"
#include "ns3/nnn-probability-policy.h"
