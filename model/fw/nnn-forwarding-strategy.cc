  ...
  namespace nnn
  {
    ...
    TypeId ForwardingStrategy::GetTypeId (void)
    {
	  ...
	  .AddTraceSource ("OutInterests",  "OutInterests",
			   MakeTraceSourceAccessor (&ForwardingStrategy::m_outInterests),
			   "ns3::nnn::ForwardingStrategy::InterestTracedCallback")
	  .AddTraceSource ("InInterests",   "InInterests",
			   MakeTraceSourceAccessor (&ForwardingStrategy::m_inInterests),
			   "ns3::nnn::ForwardingStrategy::InterestTracedCallback")
	  .AddTraceSource ("DropInterests", "DropInterests",
			   MakeTraceSourceAccessor (&ForwardingStrategy::m_dropInterests),
			   "ns3::nnn::ForwardingStrategy::InterestTracedCallback")

	  ////////////////////////////////////////////////////////////////////

	  .AddTraceSource ("OutData",  "OutData",
			   MakeTraceSourceAccessor (&ForwardingStrategy::m_outData),
			   "ns3::nnn::ForwardingStrategy::DataTracedCallback")
	  .AddTraceSource ("InData",   "InData",
			   MakeTraceSourceAccessor (&ForwardingStrategy::m_inData),
			   "ns3::nnn::ForwardingStrategy::DataTracedCallback")
	  .AddTraceSource ("DropData", "DropData",
			   MakeTraceSourceAccessor (&ForwardingStrategy::m_dropData),
			   "ns3::nnn::ForwardingStrategy::DataTracedCallback")
	  ...
	  .AddTraceSource ("SatisfiedInterests", "SatisfiedInterests",
			   MakeTraceSourceAccessor (&ForwardingStrategy::m_satisfiedInterests),
			   "ns3::nnn:ForwardingStrategy::PITEntryTracedCallback")
	  .AddTraceSource ("TimedOutInterests", "TimedOutInterests",
			   MakeTraceSourceAccessor (&ForwardingStrategy::m_timedOutInterests),
			   "ns3::nnn:ForwardingStrategy::PITEntryTracedCallback")
	  ...
	  .AddTraceSource ("Got3NName", "Traces when the forwarding strategy has a 3N name",
			   ...
			   "ns3::nnn::ForwardingStrategy::NNNAddrTracedCallback")
    ...
    void
    ForwardingStrategy::ProcessInterest (Ptr<NNNPDU> pdu, Ptr<Face> face, Ptr<Interest> interest)
    {
    ...
    void
    ForwardingStrategy::ProcessData (Ptr<NNNPDU> pdu, Ptr<Face> face, Ptr<Data> data)
    {
    ...
    bool
    ForwardingStrategy::DoPropagateData(Ptr<NNNPDU> pdu, Ptr<Face> inFace, Ptr<const Data> data)
    {
      NS_LOG_FUNCTION (this);
