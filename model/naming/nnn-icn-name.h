 ...
 *
 *  nnn-icn-name.h is free software: you can redistribute it and/or modify
 *  it under the terms of the GNU Affero General Public License as published by
 *  the Free Software Foundation, either version 3 of the License, or
 *  (at your option) any later version.
 *
 *  nnn-icn-name.h is distributed in the hope that it will be useful,
 *  but WITHOUT ANY WARRANTY; without even the implied warranty of
 *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 *  GNU Affero General Public License for more details.
 *
 *  You should have received a copy of the GNU Affero General Public License
 *  along with nnn-icn-name.h. If not, see <http://www.gnu.org/licenses/>.
 *
 *  Author: Jairo Eduardo Lopez <jairo@ruri.waseda.jp>
 *
 *   Initial implementation made by Alexander Afanasyev and Zhenkai Zhu for
...
/**
 * @ingroup icn
 * @brief Class for ICN Name
 */
class Name : public SimpleRefCount<Name>
{
public:
  typedef std::vector<nnn::name::Component>::iterator iterator;
  typedef std::vector<nnn::name::Component>::const_iterator const_iterator;
  typedef std::vector<nnn::name::Component>::reverse_iterator reverse_iterator;
  typedef std::vector<nnn::name::Component>::const_reverse_iterator const_reverse_iterator;
  typedef std::vector<nnn::name::Component>::reference reference;
  typedef std::vector<nnn::name::Component>::const_reference const_reference;

  typedef nnn::name::Component partial_type;
   ...
   */
  inline Name &
  append (const nnn::name::Component &comp);
   ...
   */
  inline Name &
  appendBySwap (nnn::name::Component &comp);
   ...
   * @see get
   */
  inline const nnn::name::Component &
...
private:
  std::vector<nnn::name::Component> m_comps;
};
...
inline Name &
Name::append (const nnn::name::Component &comp)
{
  if (comp.size () != 0)
...
inline Name &
Name::appendBySwap (nnn::name::Component &comp)
{
  if (comp.size () != 0)
    {
      Name::iterator newComp = m_comps.insert (end (), nnn::name::Component ());
      newComp->swap (comp);
    }
  return *this;
}
...
{
  nnn::name::Component comp (compStr);
...
{
  nnn::name::Component comp (buf, size);
  return appendBySwap (comp);
}
