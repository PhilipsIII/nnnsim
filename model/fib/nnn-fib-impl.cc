...
namespace ns3
{
  ...
  namespace nnn
  {
	...
	if (item == super::end ())
      ...
      Ptr<fib::Entry>
      FibImpl::Find (const icn::Name &prefix)
      {
	...
	if (item == super::end ())
      ...
      Ptr<Entry>
      FibImpl::Add (const icn::Name &prefix, Ptr<Face> face, int32_t metric)
      {
	return Add (Create<icn::Name> (prefix), face, metric);
      }

      Ptr<Entry>
      FibImpl::Add (const Ptr<const icn::Name> &prefix, Ptr<Face> face, int32_t metric)
      {
	...
	if (result.first != super::end ())
      ...
      void
      FibImpl::Remove (const Ptr<const icn::Name> &prefix)
      {
